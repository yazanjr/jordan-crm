...
function KanbanBoard({ deals, setDeals, onSelectDeal, onUpdateDeal, cardVariant = 'standard', onColumnMenu, onCardMenu, quickAddStage, onQuickAdd, onStartQuickAdd, onCancelQuickAdd }) {
  ...
  const handleDrop = (stage) => {
    ...
    setDeals(deals.map(d => d.id === draggingId ? { ...d, stage } : d));
    setDraggingId(null);
