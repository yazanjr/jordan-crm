  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <button onClick={e => onUserMenu?.(e.currentTarget.getBoundingClientRect())} title={collapsed ? 'Hala Jaber — Sales manager' : undefined} style={{
          padding: 0, border: 'none', background: 'transparent', cursor: 'pointer', flexShrink: 0,
          display: 'inline-flex', alignItems: 'center',
        }}>
          <window.Avatar name="Hala Jaber" size={30} />
        </button>
        {!collapsed && (
          <>
            <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
              <span style={{ fontSize: 12, fontWeight: 600, color: '#fff' }}>Hala Jaber</span>
              <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.65)' }}>Sales manager</span>
            </div>
